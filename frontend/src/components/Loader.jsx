  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 space-y-4">
      <div className="relative w-16 h-16">
        <div className="absolute inset-0 rounded-full border-4 border-slate-100 dark:border-dark-700"></div>
      ...
      <p className="text-sm font-semibold tracking-wide text-slate-500 dark:text-slate-400 font-display animate-pulse">{text}</p>
    </div>
  );
};
